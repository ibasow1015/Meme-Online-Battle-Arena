...
class backGround(pygame.sprite.Sprite):
    def __init__(self):
        ...
        self.road_h = pygame.image.load(
            os.path.join('sprites/grass_road_h.png'))
        self.road_h = pygame.transform.scale(self.road_h, (1000, 1000))
        self.road_c3 = pygame.image.load(
            os.path.join('sprites/grass_road_c3.png'))
        self.road_c3 = pygame.transform.scale(self.road_c3, (1000, 1000))
        self.road_c4 = pygame.image.load(
            os.path.join('sprites/grass_road_c4.png'))
        self.road_c4 = pygame.transform.scale(self.road_c4, (1000, 1000))
        self.road_c1 = pygame.image.load(
            os.path.join('sprites/grass_road_c1.png'))
        self.road_c1 = pygame.transform.scale(self.road_c1, (1000, 1000))
        self.road_c2 = pygame.image.load(
            os.path.join('sprites/grass_road_c2.png'))
        self.road_c2 = pygame.transform.scale(self.road_c2, (1000, 1000))
        self.road_d = pygame.image.load(
            os.path.join('sprites/grass_road_d.png'))
        self.road_d = pygame.transform.scale(self.road_d, (1000, 1000))
        self.road_du = pygame.image.load(
            os.path.join('sprites/grass_road_du.png'))
        self.road_du = pygame.transform.scale(self.road_du, (1000, 1000))
        self.road_dd = pygame.image.load(
            os.path.join('sprites/grass_road_dd.png'))
        self.road_dd = pygame.transform.scale(self.road_dd, (1000, 1000))
        self.road_vdl = pygame.image.load(
            os.path.join('sprites/grass_road_vdl.png'))
        self.road_vdl = pygame.transform.scale(self.road_vdl, (1000, 1000))
        self.road_vdr = pygame.image.load(
            os.path.join('sprites/grass_road_vdr.png'))
        self.road_vdr = pygame.transform.scale(self.road_vdr, (1000, 1000))
        self.road_hdd = pygame.image.load(
            os.path.join('sprites/grass_road_hdd.png'))
        self.road_hdd = pygame.transform.scale(self.road_hdd, (1000, 1000))
        self.road_hdu = pygame.image.load(
            os.path.join('sprites/grass_road_hdu.png'))
        self.road_hdu = pygame.transform.scale(self.road_hdu, (1000, 1000))
        self.road_v = pygame.image.load(
            os.path.join('sprites/grass_road_v.png'))
...
def drawBoard(data, display):
    ...
    for i in range(7):
        for j in range(7):
            ...
            display.blit(data.backGround.image,
